    ...
    function tk3(module, __webpack_exports__, __webpack_require__) {
          ...
          if (!headers) {
            ...
            this.lazyInit = function () {
              ...
              headers.split('\n').forEach(function (line) {
                ...
                if (index > 0) {
                  ...
                  _this13.maybeSetNormalizedName(name, key);

                  if (_this13.headers.has(key)) {
                    _this13.headers.get(key).push(value);
                  } else {
                    _this13.headers.set(key, [value]);
                  }
                }
              });
            };
            ...
            this.lazyInit = function () {
              ...
              Object.keys(headers).forEach(function (name) {
                ...
                if (values.length > 0) {
                  _this13.headers.set(key, values);
        ...
        _createClass(HttpHeaders, [{
            ...
            if (!!this.lazyInit) {
              ...
              if (!!this.lazyUpdate) {
                this.lazyUpdate.forEach(function (update) {
                  return _this14.applyUpdate(update);
                });
                this.lazyUpdate = null;
              }
            }
          ...
          value: function copyFrom(other) {
            ...
            Array.from(other.headers.keys()).forEach(function (key) {
              _this15.headers.set(key, other.headers.get(key));

              _this15.normalizedNames.set(key, other.normalizedNames.get(key));
            });
          }
        }, {
          key: "clone",
          ...
          value: function forEach(fn) {
            ...
            Array.from(this.normalizedNames.keys()).forEach(function (key) {
              return fn(_this16.normalizedNames.get(key), _this16.headers.get(key));
            });
          }
        }]);
        ...
        function HttpParams() {
          ...
          if (!!options.fromString) {
            ...
            Object.keys(options.fromObject).forEach(function (key) {
              ...
              _this17.map.set(key, Array.isArray(value) ? value : [value]);
            });
          } else {
            this.map = null;
          }
        ...
        _createClass(HttpParams, [{
          ...
          value: function toString() {
            ...
            return this.keys().map(function (key) {
              var eKey = _this18.encoder.encodeKey(key); // `a: ['1']` produces `'a=1'`
              // `b: []` produces `''`
              // `c: ['1', '2']` produces `'c=1&c=2'`


              return _this18.map.get(key).map(function (value) {
                return eKey + '=' + _this18.encoder.encodeValue(value);
              }).join('&');
          ...
          value: function init() {
            ...
            if (this.cloneFrom !== null) {
              ...
              this.cloneFrom.keys().forEach(function (key) {
                return _this19.map.set(key, _this19.cloneFrom.map.get(key));
              });
              this.updates.forEach(function (update) {
                switch (update.op) {
                  case 'a':
                  case 's':
                    var base = (update.op === 'a' ? _this19.map.get(update.param) : undefined) || [];
                    base.push(update.value);

                    _this19.map.set(update.param, base);

                    break;

                  case 'd':
                    if (update.value !== undefined) {
                      var _base = _this19.map.get(update.param) || [];
                      ...
                      if (_base.length > 0) {
                        _this19.map.set(update.param, _base);
                      } else {
                        _this19.map["delete"](update.param);
                      }
                    } else {
                      _this19.map["delete"](update.param);
      ...
      var HttpHeaderResponse = /*#__PURE__*/function (_HttpResponseBase) {
        ...
        function HttpHeaderResponse() {
          ...
          _this20.type = HttpEventType.ResponseHeader;
          return _this20;
        }
        /**
      ...
      var HttpResponse = /*#__PURE__*/function (_HttpResponseBase2) {
        ...
        function HttpResponse() {
          ...
          _this21.type = HttpEventType.Response;
          _this21.body = init.body !== undefined ? init.body : null;
          return _this21;
        }
      ...
      var HttpErrorResponse = /*#__PURE__*/function (_HttpResponseBase3) {
        ...
        function HttpErrorResponse(init) {
          ...
          _this22 = _super4.call(this, init, 0, 'Unknown Error');
          _this22.name = 'HttpErrorResponse';
          /**
           * Errors are never okay, even when the status code is in the 2xx success range.
           */

          _this22.ok = false; // If the response was successful, then this was a parse error. Otherwise, it was
          // a protocol-level failure of some sort. Either the request failed in transit
          // or the server returned an unsuccessful status code.

          if (_this22.status >= 200 && _this22.status < 300) {
            _this22.message = "Http failure during parsing for ".concat(init.url || '(unknown url)');
          } else {
            _this22.message = "Http failure response for ".concat(init.url || '(unknown url)', ": ").concat(init.status, " ").concat(init.statusText);
          }

          _this22.error = init.error || null;
          return _this22;
        }
          ...
          _createClass(HttpClient, [{
            ...
            value: function request(first, url) {
              ...
              var events$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMap"])(function (req) {
                return _this23.handler.handle(req);
          ...
          _createClass(JsonpClientBackend, [{
            ...
            value: function handle(req) {
              ...
              return new rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"](function (observer) {
                ...
                _this24.callbackMap[callback] = function (data) {
                  // Data has been received from the JSONP script. Firstly, delete this callback.
                  delete _this24.callbackMap[callback]; // Next, make sure the request wasn't cancelled in the meantime.
                ...
                var cleanup = function cleanup() {
                  ...
                  delete _this24.callbackMap[callback];
                ...
                var onLoad = function onLoad(event) {
                  ...
                  _this24.resolvedPromise.then(function () {
                    // Cleanup the page.
                ...
                _this24.document.body.appendChild(node); // The request has now been successfully sent.
          ...
          _createClass(HttpXhrBackend, [{
            ...
            value: function handle(req) {
              ...
              return new rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"](function (observer) {
                ...
                var xhr = _this25.xhrFactory.build();
        ...
        var Moment = /*#__PURE__*/function () {
          function Moment(document) {
            ...
            this.photoUrl$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["defer"])(function () {
              return _this26.getAttachment(Moment.PHOTO_ATTACHMENT_ID).getData();
            ...
            this.thumbnailUrl$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["defer"])(function () {
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(_this26.document.getAttachment(Moment.THUMBNAIL_ATTACHMENT_ID));
...
//# sourceMappingURL=1-es5.6ef195e63c63e8bc6a0a.js.map