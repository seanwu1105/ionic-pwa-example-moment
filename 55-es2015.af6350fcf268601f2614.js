...
const startTapClick = (config) => {
  ...
  const onMouseDown = (ev) => {
    const t = Object(_helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_0__["n"])(ev) - MOUSE_WAIT;
    if (lastTouch < t) {
      pointerDown(ev);
    }
  };
  ...
  const setActivatedElement = (el, ev) => {
    ...
    clearTimeout(activeDefer);
    activeDefer = undefined;
    const { x, y } = Object(_helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_0__["p"])(ev);
    // deactivate selected
    if (activatableEle) {
...
//# sourceMappingURL=55-es2015.af6350fcf268601f2614.js.map