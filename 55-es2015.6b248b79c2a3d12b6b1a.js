...
const startTapClick = (config) => {
  ...
  const onMouseDown = (ev) => {
    const t = Object(_helpers_cf6e85ee_js__WEBPACK_IMPORTED_MODULE_0__["o"])(ev) - MOUSE_WAIT;
    if (lastTouch < t) {
      pointerDown(ev);
    }
  };
  ...
  const setActivatedElement = (el, ev) => {
    ...
    clearTimeout(activeDefer);
    activeDefer = undefined;
    const { x, y } = Object(_helpers_cf6e85ee_js__WEBPACK_IMPORTED_MODULE_0__["p"])(ev);
    // deactivate selected
    if (activatableEle) {
...
//# sourceMappingURL=55-es2015.6b248b79c2a3d12b6b1a.js.map