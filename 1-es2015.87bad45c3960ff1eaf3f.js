...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JunctureThumbnailComponent", function() { return JunctureThumbnailComponent; });
...
function JunctureThumbnailComponent_ng_container_0_app_image_1_Template(rf, ctx) {
    ...
    if (rf & 2) {
        ...
        const juncture_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]().ngrxLet;
...
function JunctureThumbnailComponent_ng_container_0_Template(rf, ctx) {
    ...
    if (rf & 2) {
        const juncture_r1 = ctx.ngrxLet;
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngrxLet", juncture_r1.thumbnailUrl$);
    }
}
let JunctureThumbnailComponent = /*@__PURE__*/ (() => {
    class JunctureThumbnailComponent {
        constructor() {
            this._juncture$ = new rxjs__WEBPACK_IMPORTED_MODULE_0__["BehaviorSubject"](undefined);
            this.juncture$ = this._juncture$.pipe(Object(_utils_rx_operators__WEBPACK_IMPORTED_MODULE_2__["isNonNullable"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["distinctUntilChanged"])((x, y) => x.id === y.id));
        }
        set juncture(value) {
            this._juncture$.next(value);
        }
    }
    JunctureThumbnailComponent.ɵfac = function JunctureThumbnailComponent_Factory(t) { return new (t || JunctureThumbnailComponent)(); };
    JunctureThumbnailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: JunctureThumbnailComponent, selectors: [["app-juncture-thumbnail"]], inputs: { juncture: "juncture" }, decls: 1, vars: 1, consts: [[4, "ngrxLet"], ["routerLink", "photo", "class", "ion-activatable", 3, "queryParams", "src", 4, "ngrxLet"], ["routerLink", "photo", 1, "ion-activatable", 3, "queryParams", "src"]], template: function JunctureThumbnailComponent_Template(rf, ctx) {
            if (rf & 1) {
...
/* harmony import */ var _shared_juncture_juncture_repository_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../shared/juncture/juncture-repository.service */ "kTgZ");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _juncture_thumbnail_juncture_thumbnail_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./juncture-thumbnail/juncture-thumbnail.component */ "08Px");
...
function HomePage_ion_col_3_Template(rf, ctx) {
    ...
    if (rf & 2) {
        const juncture_r1 = ctx.$implicit;
...
let HomePage = /*@__PURE__*/ (() => {
    class HomePage {
        constructor(popoverController, modalController, junctureRepository) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Juncture", function() { return Juncture; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "qCKp");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
...
let Juncture = /*@__PURE__*/ (() => {
    class Juncture {
        constructor(document) {
            ...
            this.photoUrl$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["defer"])(() => this.getAttachment(Juncture.PHOTO_ATTACHMENT_ID).getData()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(blob => URL.createObjectURL(blob)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])({ bufferSize: 1, refCount: true }));
            this.thumbnailUrl$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["defer"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(this.document.getAttachment(Juncture.THUMBNAIL_ATTACHMENT_ID))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMap"])((attachment) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                if (attachment)
                    return attachment.getData();
                const thumbnail = yield Object(_utils_thumbnail__WEBPACK_IMPORTED_MODULE_4__["makeThumbnail"])({
                    image: yield this.getAttachment(Juncture.PHOTO_ATTACHMENT_ID).getData(),
                    maxSize: 300,
                });
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ionic/angular */ "TEn/");
/* harmony import */ var _shared_juncture_juncture_repository_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../shared/juncture/juncture-repository.service */ "kTgZ");
...
let CameraComponent = /*@__PURE__*/ (() => {
    let CameraComponent = class CameraComponent {
        constructor(modalController, alertController, junctureRepository) {
            this.modalController = modalController;
        ...
        capture() {
            ...
            }), Object(_utils_rx_operators__WEBPACK_IMPORTED_MODULE_4__["concatTap"])(imageBlob => this.junctureRepository.add$(imageBlob)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])((err) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
/* harmony import */ var _juncture_thumbnail_juncture_thumbnail_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./juncture-thumbnail/juncture-thumbnail.component */ "08Px");
/* harmony import */ var _settings_settings_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./settings/settings.component */ "k0O3");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵsetNgModuleScope"](HomePageModule, { declarations: [_home_page__WEBPACK_IMPORTED_MODULE_4__["HomePage"],
            ...
            _juncture_thumbnail_juncture_thumbnail_component__WEBPACK_IMPORTED_MODULE_5__["JunctureThumbnailComponent"]], imports: [_shared_shared_module__WEBPACK_IMPORTED_MODULE_1__["SharedModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_3__["HomePageRoutingModule"], ngx_ionic_image_viewer__WEBPACK_IMPORTED_MODULE_0__["NgxIonicImageViewerModule"]] });
})();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JunctureRepository", function() { return JunctureRepository; });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ "qCKp");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
...
/* harmony import */ var _juncture__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./juncture */ "Ile0");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
let JunctureRepository = /*@__PURE__*/ (() => {
    class JunctureRepository {
        constructor(database) {
            ...
            this.collection$ = this.database.main$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["concatMap"])(database => database.addCollections({
                [COLLECTION_NAME]: { schema: _juncture__WEBPACK_IMPORTED_MODULE_4__["schema"] },
            ...
            this.all$ = this.collection$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["concatMap"])(c => c.find().sort({ timestamp: 'desc' }).$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(documents => documents.map(d => new _juncture__WEBPACK_IMPORTED_MODULE_4__["Juncture"](d))));
        }
        add$(photo) {
            ...
            })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["concatMap"])(document => document.putAttachment({ id: _juncture__WEBPACK_IMPORTED_MODULE_4__["Juncture"].PHOTO_ATTACHMENT_ID, data: photo, type: photo.type }, true)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(attachment => attachment.doc));
        }
        remove$(id) {
            return this.collection$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["concatMap"])(c => c.bulkRemove([id])));
        }
    }
    JunctureRepository.ɵfac = function JunctureRepository_Factory(t) { return new (t || JunctureRepository)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_database_database_service__WEBPACK_IMPORTED_MODULE_6__["Database"])); };
    JunctureRepository.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjectable"]({ token: JunctureRepository, factory: JunctureRepository.ɵfac, providedIn: 'root' });
