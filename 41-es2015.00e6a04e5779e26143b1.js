...
const Slides = class {
  ...
  connectedCallback() {
    ...
    if (typeof MutationObserver !== 'undefined') {
      ...
      Object(_helpers_cf6e85ee_js__WEBPACK_IMPORTED_MODULE_2__["c"])(this.el, () => {
        if (!this.didInit) {
          this.didInit = true;
          this.initSwiper();
        }
  ...
  async initSwiper() {
    ...
    // init swiper core
    // @ts-ignore
    const { Swiper } = await __webpack_require__.e(/*! import() */ 54).then(__webpack_require__.bind(null, /*! ./swiper.bundle-95afeea2.js */ "7WBn"));
  ...
  render() {
    ...
    return (Object(_index_3ccd7557_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_3ccd7557_js__WEBPACK_IMPORTED_MODULE_0__["H"], { class: {
      ...
      } }, Object(_index_3ccd7557_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "swiper-wrapper" }, Object(_index_3ccd7557_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)), this.pager && Object(_index_3ccd7557_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "swiper-pagination", ref: el => this.paginationEl = el }), this.scrollbar && Object(_index_3ccd7557_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "swiper-scrollbar", ref: el => this.scrollbarEl = el })));
  }
...
const waitForSlides = (el) => {
  return Promise.all(Array.from(el.querySelectorAll('ion-slide')).map(s => new Promise(resolve => Object(_helpers_cf6e85ee_js__WEBPACK_IMPORTED_MODULE_2__["c"])(s, resolve))));
};
Slides.style = {
  ios: slidesIosCss,
  md: slidesMdCss
...
//# sourceMappingURL=41-es2015.00e6a04e5779e26143b1.js.map