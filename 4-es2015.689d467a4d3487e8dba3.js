...
let CameraPage = /*@__PURE__*/ (() => {
    let CameraPage = class CameraPage {
        ...
        reverseCamera() {
            return this.videoElement$
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])(videoElement => this.cameraService.nextCamera$(videoElement)), Object(_ngneat_until_destroy__WEBPACK_IMPORTED_MODULE_1__["untilDestroyed"])(this))
                .subscribe();
        }
    };
...
let CameraService = /*@__PURE__*/ (() => {
    class CameraService {
        constructor() {
            this.videoStreamSelector = new VideoStreamSelector();
            this.videoDevices$ = this.videoStreamSelector.devices$;
            this.mediaStream$ = this.videoStreamSelector.stream$;
        ...
        connectPreview$(videoElement) {
            return this.mediaStream$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(mediaStream => (videoElement.srcObject = mediaStream)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["mapTo"])(videoElement));
        }
        capture$() {
        ...
        nextCamera$(videoElement) {
            return this.videoDevices$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMap"])(devices => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["iif"])(() => devices.length > 1, Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["defer"])(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () { return (videoElement.srcObject = null); })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMapTo"])(this.videoStreamSelector.next$())))));
        }
    }
...
class VideoStreamSelector {
    constructor() {
        this.devices$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["defer"])(() => navigator.mediaDevices.enumerateDevices()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(devices => devices.filter(d => d.kind === 'videoinput')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])({ bufferSize: 1, refCount: true }));
        this.currentVideoDeviceIndex = 0;
        this._stream$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__["ReplaySubject"](1);
        this.stream$ = this.devices$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMap"])(devices => this.getCurrentVideoMedia(devices)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(mediaStream => this._stream$.next(mediaStream)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMapTo"])(this._stream$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])({ bufferSize: 1, refCount: true }), Object(_utils_rx_operators__WEBPACK_IMPORTED_MODULE_3__["isNonNullable"])(), Object(_utils_rx_operators__WEBPACK_IMPORTED_MODULE_3__["finalizeLast"])(mediaStream => stopMediaStream(mediaStream)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])({ bufferSize: 1, refCount: true }));
    }
    next$() {
        return this.stream$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(mediaStream => mediaStream.getVideoTracks().forEach(t => t.stop())), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMapTo"])(this.devices$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(() => this.currentVideoDeviceIndex++), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMap"])(devices => this.getCurrentVideoMedia(devices)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(mediaStream => this._stream$.next(mediaStream)));
    }
    getCurrentVideoMedia(devices) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return navigator.mediaDevices.getUserMedia({
                video: {
                    deviceId: devices[this.currentVideoDeviceIndex % devices.length].deviceId,
                },
            });
        });
    }
...
//# sourceMappingURL=4-es2015.689d467a4d3487e8dba3.js.map